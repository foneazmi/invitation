    ...
    <AnimationContainer>
      <div className="columns-2 mt-12 flex md:flex-row flex-col">
        <div className="flex-1 bg-base-300 p-4 rounded-lg md:mr-2 mr-0">
          ...
          <p className="font-poppins text-xs">Manusia pertama</p>
        </div>
        <div className="flex-1 bg-base-300 p-4 rounded-lg text-right md:mt-0 mt-4 md:ml-2 mr-0">
          <p className="font-poppins text-md">Hawa</p>
          <p className="font-poppins text-xs">Wanita pertama</p>
        </div>
      </div>
    </AnimationContainer>
    <AnimationContainer>
      ...
      <div className="mockup-phone">
        ...
        <div className="display">
          <div className="artboard phone-1 flex flex-col">
            <div className="bg-base-300 pt-10 px-4 pb-4 flex justify-between">
              <h1>
                <b>Ucapan & Doa</b>
              </h1>
            </div>
            <div className="bg-base-100 p-4 flex-1 overflow-y-auto no-scrollbar">
